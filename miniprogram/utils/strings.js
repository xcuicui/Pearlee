...
const STRINGS = {
  ...
  REWARDS_WINDOW_SEG_TO_ME: '给我',
  REWARDS_WINDOW_SEG_SENT_BY_ME: '我送出',
  REWARDS_WINDOW_FROM_PARTNER: '来自 {partnerNickname}',
  REWARDS_WINDOW_TO_PARTNER: '送给 {partnerNickname}',
  REWARDS_WINDOW_DELETE_ACTION: '移出橱窗',
  REWARDS_WINDOW_DELETE_MODAL_TITLE: '移出这份小礼物？',
  REWARDS_WINDOW_DELETE_MODAL_CONTENT: '移出后它不会再出现在橱窗里，也不会再被抽到。',
  REWARDS_WINDOW_DELETE_MODAL_CONFIRM: '移出',
  REWARDS_WINDOW_DELETE_MODAL_CANCEL: '取消',
  REWARDS_WINDOW_ADD_GIFT: '放一份礼物',
  REWARDS_WINDOW_EMPTY_TO_ME: '还没有给你的小礼物',
  REWARDS_WINDOW_EMPTY_SENT: '你还没有送出小礼物',
  REWARDS_WINDOW_ADD_TITLE: '放进橱窗',
  REWARDS_WINDOW_ADD_NAME_LABEL: '名称',
  REWARDS_WINDOW_ADD_NAME_PLACEHOLDER: '给这份礼物起个名字（12字内）',
  REWARDS_WINDOW_ADD_DESC_LABEL: '描述',
  REWARDS_WINDOW_ADD_DESC_PLACEHOLDER: '写一句温柔说明（40字内）',
  REWARDS_WINDOW_ADD_RARITY_LABEL: '稀有度',
  REWARDS_WINDOW_ADD_RECIPIENT_LABEL: '送给谁',
  REWARDS_WINDOW_ADD_SUBMIT: '放进橱窗',
  REWARDS_WINDOW_ADD_RECIPIENT_PARTNER: '送给 {partnerNickname}',
  REWARDS_WINDOW_ADD_RECIPIENT_ME: '送给我',
  REWARDS_WINDOW_ADD_SUBMITTING: '提交中...',
  REWARDS_WINDOW_DELETE_PROCESSING: '处理中...',
  REWARDS_WINDOW_ADD_ERR_NAME_REQUIRED: '请填写礼物名称',
  REWARDS_WINDOW_ADD_ERR_RARITY_REQUIRED: '请选择稀有度',
  REWARDS_WINDOW_ADD_ERR_RECIPIENT_REQUIRED: '请选择送给谁',
  REWARDS_RARITY_COMMON_DESC: '更容易遇见',
  REWARDS_RARITY_OCCASIONAL_DESC: '偶尔出现',
  REWARDS_RARITY_RARE_DESC: '很少出现',
  REWARDS_DRAW_POOL_EMPTY_TIP: '橱窗里还没有给你的小礼物。',
  REWARDS_POCKET_REMOVED: '已从橱窗移出',
  REWARDS_POINTS_HELP_TITLE: '贝壳说明',
  REWARDS_POINTS_HELP_SOURCE_TITLE: '贝壳从哪里来',
  REWARDS_POINTS_HELP_SOURCE_LINE_1: '• 每日打卡可获得贝壳',
  REWARDS_POINTS_HELP_SOURCE_LINE_2: '• 完成页面中的部分任务也可能获得贝壳',
  REWARDS_POINTS_HELP_USAGE_TITLE: '贝壳怎么用',
  REWARDS_POINTS_HELP_USAGE_LINE_1: '• 抽一次小礼物会消耗 1 枚贝壳',
  REWARDS_POINTS_HELP_USAGE_LINE_2: '• 消耗贝壳后可获得小礼物券，并可在券包中查看',
  REWARDS_POINTS_HELP_TIPS_TITLE: '温馨提示',
  REWARDS_POINTS_HELP_TIPS_LINE_1: '• 贝壳与小礼物券仅用于应用内互动体验',
